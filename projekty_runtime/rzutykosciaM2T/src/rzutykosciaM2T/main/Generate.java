...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/rzutykosciaM2T/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(Rzutykoscia.RzutykosciaPackage.class)) {
            resourceSet.getPackageRegistry().put(Rzutykoscia.RzutykosciaPackage.eINSTANCE.getNsURI(), Rzutykoscia.RzutykosciaPackage.eINSTANCE);
        }
