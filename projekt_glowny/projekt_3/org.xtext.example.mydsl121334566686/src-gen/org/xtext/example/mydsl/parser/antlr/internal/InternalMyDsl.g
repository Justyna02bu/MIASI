	...
	(
		(
			...
			(
				...
				{
					$current = $this_SuccessThreshold_1.current;
					afterParserOrEnumRuleCall();
				}
				    |
				{
				...
				{
					$current = $this_SuccessMultiplier_2.current;
					afterParserOrEnumRuleCall();
				}
				    |
				{
				...
				{
					$current = $this_SuccessBasic_3.current;
					afterParserOrEnumRuleCall();
				}
			)
		)
		...
		{
			$current = $this_DiceMarkSuk_4.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_DiceDiscSuk_5.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_DiceRerollSuk_6.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
// Rule FirstLast
ruleFirstLast returns [Enumerator current=null]
@init {
	enterRule();
}
@after {
